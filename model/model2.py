...
class Generator_Net(nn.Module):
    def __init__(self, is_rgb = False):
        ...
        self.conlstm1 = ConvLSTM(input_size=(28, 28), input_dim=512, hidden_dim=[256, 512], 
                                 kernel_size=(3, 3), num_layers=2, batch_first=True, bias=True, return_all_layers=True)
